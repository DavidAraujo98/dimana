...
| Nome                                  | Contribuição                                                                                                                                                                                                                                                                                                     |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| DAVID JOSÉ ARAÚJO FERREIRA          | *Elaboração completa da gramática no Grammar.g4.``*Colaboração no desenvolvimento do tratamento dos `use`.``*Colaboração no desenvolvimento do GrammarMain.``*Elaboração dos shell scripts finais.                                                                                                       |
